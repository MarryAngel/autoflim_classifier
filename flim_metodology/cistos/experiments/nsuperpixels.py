...
def copy_superpixels_folder(random_state, superpixel):
    ...
    dest_dir = os.path.join(base_dir, dataset_name,'experiments', 'nsuperpixels', 'results', f'super{superpixel}', f'superpixels_seed{random_state}')
...
def main():
    ...
    superpixels = [15, 25, 50, 75, 100, 150, 200]  
    # random_indices = [42, 2735, 6854, 7580, 8900, 123, 456, 789, 1011, 1213]
    random_indices = [123, 456, 789, 1011, 1213]
    split = 1
    num_classes = 6
