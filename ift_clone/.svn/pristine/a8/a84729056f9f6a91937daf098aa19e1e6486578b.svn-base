...
class MainNet(nn.Module): # autoria André
    ...
    def forward(self, x):
        ...
        # print('Cuda Pre processamento: ', start.elapsed_time(end)/1000)
        ...
        # tic = time()
        # print('Cuda Extrator de caracteristicas: ', start.elapsed_time(end)/1000)
        ...
        torch.cuda.synchronize()
        # print('Cuda ASPP: ', start.elapsed_time(end)/1000)
        ...
        torch.cuda.synchronize()
        # tic = time()
        # print('Cuda Ori/Seg: ', start.elapsed_time(end)/1000)
        ...
        torch.cuda.synchronize()
        # print('Cuda Ori highest peak:', start.elapsed_time(end)/1000)
        ...
        torch.cuda.synchronize()
        # debug_# tic = time()
        # print('Cuda Ori select max:', start.elapsed_time(end)/1000)
        ...
        torch.cuda.synchronize()
        # print('Cuda Mul masks:', start.elapsed_time(end)/1000)
        ...
        torch.cuda.synchronize()
        # print('Cuda Torch atan2 + cat:', start.elapsed_time(end)/1000)
        ...
        # print('Cuda Mnt part: ', start.elapsed_time(end)/1000)
