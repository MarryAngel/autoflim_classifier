...
```bash
python3 fingerprint_registration.py ../input_samples/sample_comparisons.txt ../input_samples/sample_images/ ../input_samples/sample_mnts/ ../input_samples/sample_matches/ output
```
